...
from megatron.training.utils import get_batch_on_this_cp_rank, get_batch_on_this_tp_rank, is_rank0
...
def training_log(loss_dict, total_loss_dict, learning_rate, decoupled_learning_rate, iteration,
    ...
    if args.num_experts is not None:
        ...
        if args.num_moe_zero_experts is not None and args.num_moe_zero_experts > 0:
            ...
            track_names.append('avg_ffn_expert_usage_per_token')
            track_names.append('std_ffn_expert_usage_per_token')
        track_moe_metrics(
